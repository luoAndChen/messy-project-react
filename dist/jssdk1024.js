var tmp_user_info = {
  ...
  "data": {
    "roles": {
      "data": [
        {
          "appId": "O5GMVymiQ8GjZx-P_KuBsw",
          "code": "default",
          "defaultRole": true,
          "id": "91P0RafPS9GNZtAI4q50rA",
          "name": "普通角色"
        }
      ]
    },
    "detail": {
      "data": {
        "orgIds": [
          "s96Kvna7T6yicegxIQKJV4Q"
          // "1"
        ],
        "RN": 1,
        "user_address": "长沙麓谷高新技术开发区湖南大学科技园",
        "login_name": "2018383",
        "creator": "admin",
        "user_summary": "湖南大学汽车国家重点实验室",
        "user_order": "4760",
        "sex": "1",
        "lastModified": 1569769627947,
        "authLevel": "1",
        "createAt": 1569769627947,
        "SN": 999,
        "user_birthday": "1972-09-01 00:00:00.000",
        "jp": "cag",
        "certificateNum": "100265",
        "delflag": "n",
        "name": "成艾国",
        "state": "1",
        "orgAttrs": [
          {
            "user_Sector": "HuNanshengZXyunappNewNew930",
            "user_position": "湖南大学机械与运载工程学院教授、博士生导师",
            "user_bout": "一",
            "if_routine": "0",
            "user_circles": "十二",
            "orgInstanceId": "1-l-1",
            ...
            "groups": [
              {
                ...
                "is_area_code": "1",
                "org_jc": "",
                "createAt": 1569749358248,
                "creator": "admin",
                "lastModified": 1572243965570,
                "layer": "0",
                "is_institutions": "0",
                "delflag": "n",
                "pid": "1-l",
              ...
              //   "id": "1",
              //   "is_area_code": "1",
              //   "createAt": 1569749358249,
              //   "creator": "admin",
              //   "lastModified": 1571724536802,
              //   "layer": "1",
              //   "is_institutions": "0",
              //   "delflag": "n",
              //   "pid": "hnzx",
    ...
    // 159487:易小春(长沙县委员) 100265:成艾国 p3AgpsGmR8ekNXjOA8GbRA:吴四元(长沙县管理员,委员) 134893:云宝宝(省本级管理员,委员) 100758:蒋奇霖(部门副职) 100675:王一兵(部门正职) 159886:易红(长沙市管理员) 100363:曹普华 111025:吴宏亮 182913:政协云 101143:刘音飞 100363:曹普华 178876:李文伍  IaibSJBMuQaKtgeb4YF8ia6Q L7brL1MrT7WuWA0TdHjNMA
    "userId": "159886",
    "userName": "政协云",
    "C2AT": "eyJraWQiOiJXLTNZMUZXS1JZNnlhY1NGTkdGN013IiwidHlwIjoiSldUIiwiYWxnIjoiUlMyNTYifQ.eyJ1aWQiOiIxMDAyNjUiLCJhYyI6IuaIkOiJvuWbvTEiLCJpc3MiOiJjMiIsImltIjp0cnVlLCJ1biI6IuaIkOiJvuWbvTEiLCJvaWQiOlsiMSIsIjIiXSwiZXhwIjoxNTg4OTE5Njk0LCJhaWQiOiJPNUdNVnltaVE4R2paeC1QX0t1QnN3Iiwicm8iOlsiZGVmYXVsdCIsInd5anMiXSwiaWF0IjoxNTc2OTE5NjM0fQ.BqnG5WOqGgLi6BjY8R05HWVCABNO_VooSpUgCH1eYXkM6DjzW_bqtQRAUTWjR9pfiGdBkz12wob-hWB0fDQp9VnnlQfLtUM5UH7Th9SZZ9R-gS8be3SP8xVVUYg-Q7wlGrKvte1gtsss_KTbtAbrN0dyCfm30aRUtpei_-56hEA",
    "categoryId": "1-l",
    "C2RT": "e3897e9c3e31617b0197427185fb78cd",
    "C2ST": "e3897e9c3e31617b0197427185fb78cd"
  },
  "msgChannelId": "173f4636-e7e0-4777-8f9c-5362053f5827",
  "callback": "nativeGetUserInfo"
}
...
// ty	keyword	not_analyzed	操作类别(登录、功能页面,访问页面，提交数据，登录页面，浏览页面)(visit,login,rouse,browse)
//
// oty	keyword	not_analyzed	操作对象类型（包括某一个界面的名称）
// ob	keyword	not_analyzed	操作对象ID（例如微建议id）
//
//
// latency	long	Not analyzed	操作耗时（页面停留时长） //毫秒
...
var develop_config = {
  schema: 'https://',
  host: 'wyyapp.ak.c2cloud.cn',
  apps: {
    sqmy: {
      code: "sqmy",
      commentId: "Hm49n10WSLm_NWds1QiHMw"
    },
    wjy: {
      code: "wjy",
      commentId: "Lki4eTV8TL2NjIgW5-bhiA"
    },
    tpgj: {
      code: "tpgj",
      commentId: "E0DYmWCLRpuE4A4mWW5gOA"
    },
    tian: {
      code: "zxta",
      commentId: ""
    ...
    wygzs: {
      code: "zxwygzs",
      commentId: "_bmjD9n1ROGsIBqJ2f5eLQ"
    },
    hots: {
      code: "rdgz",
      commentId: "sn_BEovLQ5iibIGXc7EpGw"
    },
    lzhd: {
      code: "lzhd",
    ...
    meeting: {
      code: "ycxs",
      commentId: "LZ_Ti2U3SRak8y7xISKyUA"
    },
    zxdj: {
      code: "zxdjo",
      commentId: ""
